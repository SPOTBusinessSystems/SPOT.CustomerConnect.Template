        ...
        '<nav class="navbar navbar-default" ng-if="!$ctrl.user.getCustomer()">',
            '<div class=" container-fluid">',
                '<div class="navbar-header">',
                    ...
                    '<a class="navbar-brand brandText" href="#/login">{{ $ctrl.settings.getProfile().General[\'Brand Name\'] }}</a>',
                '</div>',
                '<div class="collapse navbar-collapse" uib-collapse="$ctrl.isCollapsed">',
                    '<ul class="nav navbar-nav">',
                        '<li role="presentation" ui-sref-active="active"><a href="#/login" ng-click="$ctrl.isCollapsed = true">Login</a></li>',
                        '<li role="presentation" ui-sref-active="active"><a href="#/signup" ng-click="$ctrl.isCollapsed = true">{{ $ctrl.settings.getProfile().Signup[\'Menu Synonym\'] }}</a></li>',
        ...
        '<nav class="navbar navbar-default" ng-if="$ctrl.user.getCustomer()">',
            '<div class="container-fluid">',
                '<div class="navbar-header">',
                    ...
                    '</button>',
                    '<img class="navbar-brand brandImgIcon" ng-src="{{ $ctrl.settings.getProfile().General[\'Logo Icon\'] }}" />',
                    '<a class="navbar-brand brandText" href="#/account" >{{ $ctrl.settings.getProfile().General[\'Brand Name\']}}</a>',
                '</div>',
                '<div class="collapse navbar-collapse" uib-collapse="$ctrl.isCollapsed">',
                    '<ul class="nav navbar-nav">',
                        '<li role="presentation" ui-sref-active="active"><a href="#/account" ng-click="$ctrl.isCollapsed = true">Account</a></li>',
                        '<li role="presentation" ui-sref-active="active" ng-show="$ctrl.settings.getProfile().General[\'Gift Cards Menu Enabled\'] == 1"><a href="#/giftcards" ng-click="$ctrl.isCollapsed = true">Gift Cards</a></li>',
                        '<li role="presentation" ui-sref-active="active" ng-show="$ctrl.settings.getProfile().General[\'Kiosk Menu Enabled\'] == 1"><a href="#/kiosk" ng-click="$ctrl.isCollapsed = true">Kiosk</a></li>',
                        '<li role="presentation" ui-sref-active="active" ng-show="$ctrl.settings.getProfile().General[\'Orders Menu Enabled\'] == 1"><a href="#/orders" ng-click="$ctrl.isCollapsed = true">Orders</a></li>',
                        '<li role="presentation" ui-sref-active="active" ng-show="($ctrl.user.getCustomer().RouteName || $ctrl.settings.getProfile().Pickup[\'Allow Non-Route Pickup\'] == 1) && $ctrl.settings.getProfile().General[\'Route Scheduling\'] == 1 && $ctrl.settings.getProfile().Pickup[\'Menu Synonym\']" ng-if="!$ctrl.isPickupCalendar()"><a href="#/pickup" ng-click="$ctrl.isCollapsed = true">{{$ctrl.settings.getProfile().Pickup[\'Menu Synonym\']}}</a></li>',
                        '<li role="presentation" ui-sref-active="active" ng-show="($ctrl.user.getCustomer().RouteName || $ctrl.settings.getProfile().Pickup[\'Allow Non-Route Pickup\'] == 1) && $ctrl.settings.getProfile().General[\'Route Scheduling\'] == 1 && $ctrl.settings.getProfile().Pickup[\'Menu Synonym\']" ng-if="$ctrl.isPickupCalendar()"><a href="#/pickupcalendar" ng-click="$ctrl.isCollapsed = true">{{$ctrl.settings.getProfile().Pickup[\'Menu Synonym\']}}</a></li>',
                        '<li role="presentation" ui-sref-active="active" ng-show="$ctrl.isLocker()"><a href="#/locker" ng-click="$ctrl.isCollapsed = true">{{$ctrl.settings.getProfile().Locker[\'Menu Synonym\']}}</a></li>',
                        '<li role="presentation" ui-sref-active="active" ng-show="$ctrl.user.getCustomer().RouteName && $ctrl.settings.getProfile().General[\'Route Scheduling\'] == 1 && $ctrl.settings.getProfile().Cancellation[\'Menu Synonym\']"><a href="#/suspend" ng-click="$ctrl.isCollapsed = true">{{$ctrl.settings.getProfile().Cancellation[\'Menu Synonym\']}}</a></li>',
                        '<li role="presentation" ui-sref-active="active" ng-show="$ctrl.user.getCustomer().IsAR == true"><a href="#/statements" ng-click="$ctrl.isCollapsed = true">Statements</a></li>',
                        '<li role="presentation" ui-sref-active="active" ng-show="$ctrl.isPayment()"><a href="#/payment" ng-click="$ctrl.isCollapsed = true">Make Payment</a></li>',
