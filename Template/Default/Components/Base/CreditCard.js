(function () {
    ...
    angular.module('app').component('creditCard', {
        ...
        template: [
            '<div layout="row">',
            '<div class="creditCardIconContainer">',
            '<md-icon class="creditCardIcon" md-font-library="material-icons">credit_card</md-icon>',
            '</div>',
                '<md-input-container class="md-icon-float md-block creditCardNumberContainer">',
                    '<label>Card Number</label>',
                    '<md-icon md-font-library="material-icons" title="Secure Payments">lock</md-icon>',
